  ...
  return (
    <div>
      ...
      <section className="d-flex align-items-center justify-content-between my-5 py-5 bg-light rounded-3 shadow-lg">
        <div className="w-75">
          <h2 className="display-4 text-primary mb-3">
            42 años y seguimos trabajando hoy mejor que ayer.
          </h2>
          ...
          <p className="text-dark">
            ...
            las instituciones educativas del país, que integra dos Sistemas de Enseñanza: La Enseñanza Bilingüe y la
            Enseñanza en Español.
          </p>
          <p className="text-dark">
            Ubicado en la Colonia Mayangle de Comayagüela, Renacimiento cuenta con un excelente staff de docentes,
            modernas instalaciones físicas para la eficiente labor educativa, tiene 4 laboratorios de computación, una
            Biblioteca Virtual, Taller de Tecnología, Laboratorios de Ciencias Naturales, áreas de recreación para los
            niveles de Pre-Básica, Básica y Media con la modalidad de Bachillerato en Ciencias y Humanidades.
          </p>
          <p className="text-dark">
            Renacimiento educa integralmente a sus estudiantes, desarrollando sus habilidades y destrezas. Promueve el
            deporte en las disciplinas de Fútbol, Básquetbol, Béisbol y Voleibol, trabaja las actividades artísticas de
            Danza Folklórica, Danza Étnica, Danza Moderna, Ballet, Banda Marcial y Violín, y fomenta el amor a Dios y
            los valores humanos en sus estudiantes.
          </p>
        </div>
        <img
        ...
        <div className="row row-cols-1 row-cols-md-3 g-4">
          {[...Array(6)].map((_, index) => (
            <div key={index} className="col">
              <div className="card">
                <img
                  src={`/path/to/card-image${index + 1}.jpg`}
                  className="card-img-top"
                  alt={`Card ${index + 1}`}
                />
                <div className="card-body">
                  <h5 className="card-title">{`Título de la Tarjeta ${index + 1}`}</h5>
